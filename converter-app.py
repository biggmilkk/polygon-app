...
st.markdown(
    ...
    "and generate population estimates using LandScan Global 2024 data from ORNL."
    "</p>",
...
if st.session_state["generate_done"] and st.session_state["coords"]:
    ...
    with st.spinner("Generating map and estimating population..."):
        ...
        pop = estimate_population_from_coords(
            polygons,
            "data/landscan-global-2024.tif"
        )
    ...
    st.markdown(
        "<h4 style='text-align: center;'>Polygon Preview</h4>",
        unsafe_allow_html=True
    )
